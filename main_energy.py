...
# Self-Written Module
from orig_paper_method_data_loading import *
from data.data_preprocess import data_preprocess
from metrics.orig_paper_method_metric_utils import (
...
def main(args):
    ...
    ## Output directories
    args.model_path = os.path.abspath(f"../output/timegan/energy/{args.exp}/")
    ...
    X,T=np.array(ori_data),ori_time
